...
#
# Interact with bswck/skeleton (current version: https://github.com/bswck/skeleton/tree/34cc9c6).
#
# This file was generated from bswck/skeleton@34cc9c6.
# Instead of changing this particular file, you might want to alter the template:
# https://github.com/bswck/skeleton/tree/34cc9c6/project/scripts/%7B%7Bsref%7D%7D.sh.jinja
#
# Usage:
#
...
# Automatically copied from https://github.com/bswck/skeleton/tree/34cc9c6/handle-task-event.sh
setup_gh() {
