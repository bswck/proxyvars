...
#
# Interact with bswck/skeleton (current version: https://github.com/bswck/skeleton/tree/7935235).
#
# This file was generated from bswck/skeleton@7935235.
# Instead of changing this particular file, you might want to alter the template:
# https://github.com/bswck/skeleton/tree/7935235/project/scripts/%7B%7Bsref%7D%7D.sh.jinja
#
# Usage:
#
...
# Automatically copied from https://github.com/bswck/skeleton/tree/7935235/handle-task-event.sh
setup_gh() {
