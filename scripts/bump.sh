...
# This script was adopted from https://github.com/bswck/skeleton/tree/5b68727/project/scripts/sync.sh.jinja
#
# Usage:
# $ poe bump
...
# Automatically copied from https://github.com/bswck/skeleton/tree/5b68727/handle-task-event.sh
make_token() {
    export TOKEN
