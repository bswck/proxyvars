...
# This script was adopted from https://github.com/bswck/skeleton/tree/e257d8b/project/scripts/sync.sh.jinja
#
# Usage:
# $ poe bump
...
# Automatically copied from https://github.com/bswck/skeleton/tree/e257d8b/handle-task-event.sh
make_token() {
    export TOKEN
